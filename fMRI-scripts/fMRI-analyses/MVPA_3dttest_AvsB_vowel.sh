...
foreach subj (1 2 3 6 8 9 10 11 12 14 15 16 17 18 20 21 22 24 25 26 27 28 30 31 32 34)
	...
	3dBlurToFWHM -FWHM 4 \
	-prefix $top_dir/group/MVPA/AvsB_vowel/res_accuracy_minus_chance_cth${subj}_blurred \
	-input $top_dir/group/MVPA/AvsB_vowel/res_accuracy_minus_chance_cth${subj}+tlrc
end
