...
subjects = {'2','3','6','8','9','10','11','12','14','15','16','17'};
...
cfg.results.dir = [dir_base 'cth' subjects{s} '/' 'cth' subjects{s} '.preproc_mvpa/searchlight/AvsB_sine-endpoints'];
