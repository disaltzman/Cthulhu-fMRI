...
subjects = {'24','25','26','27','28','30','31','32'};
...
cfg.results.dir = [dir_base 'cth' subjects{s} '/' 'cth' subjects{s} '.preproc_mvpa/searchlight/BVvsBS'];
...
cfg.results.output = {'accuracy_minus_chance', 'AUC_minus_chance'}; % 'accuracy_minus_chance' by default
