...
cfg.results.dir = [dir_base 'cth' subjects{s} '/' 'cth' subjects{s} '.preproc_mvpa/searchlight/AVvsAS'];
...
labelname3 = 'sinestep1*';
labelname4 = 'sinestep3*';
